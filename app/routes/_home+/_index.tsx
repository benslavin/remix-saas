...
export default function Index() {
  ...
  return (
    <div className="bg-card relative flex h-full w-full flex-col">
      ...
      <nav
        className={cn(
          'bg-card/20 dark:bg-secondary/20 sticky top-1.5 z-50 mx-auto flex w-full max-w-(--breakpoint-lg) items-center justify-between rounded-lg p-6 py-3 backdrop-blur-sm transition-all duration-300',
        )}>
      ...
      <div className="z-10 mx-auto flex w-full max-w-(--breakpoint-lg) flex-col gap-4 px-6">
        ...
        <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-4 p-12 md:p-24">
          <Button
            variant="outline"
            className={cn(
              'ring-primary/5 hover:text-primary dark:bg-secondary hidden h-8 rounded-full bg-white/60 px-3 text-sm font-bold ring-1 backdrop-blur-sm transition hover:brightness-110 md:flex',
            )}>
          ...
          <p className="text-muted-foreground max-w-(--breakpoint-md) text-center text-lg leading-normal! md:text-xl">
          ...
          <div className="mx-auto mt-4 flex items-center gap-3">
            <Link to="/auth/login" tabIndex={-1} className="outline-hidden">
        ...
        <div className="border-border relative z-10 flex flex-col border backdrop-blur-xs lg:flex-row">
        ...
        <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-6 p-12">
          ...
          <div className="relative flex items-center justify-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden h-10 items-center gap-2 rounded-full bg-green-500/5 px-2 py-1 pr-2.5 text-base font-medium tracking-tight text-green-600 ring-1 ring-green-600/20 backdrop-blur-xs transition-all duration-300 select-none ring-inset hover:brightness-110 md:flex dark:bg-yellow-800/40 dark:text-yellow-100 dark:ring-yellow-200/50">
              <svg
                xmlns="http://www.w3.org/2000/svg"
